...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // This will get the file path from the configuration (e.g., "..\\..\\..\\..\\csv\\")
            string filePath = GlobalConfig.AppKeyLookup("filePath");

            // Combine the file path with the base directory of the application and the filename
